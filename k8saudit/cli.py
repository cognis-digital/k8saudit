"""K8SAUDIT command-line interface."""
from __future__ import annotations
import argparse, sys
from k8saudit.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="k8saudit", description="K8SAUDIT — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from k8saudit.mcp_server import serve
        return serve()
    if args.cmd == "scan":
