#!/usr/bin/env sh
# Universal installer for k8saudit. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/k8saudit.git"
echo "Installing k8saudit ..."
